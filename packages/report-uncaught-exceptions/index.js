...
function catcher (server, next) {
  ...
  if (ROLLBAR_ACCESS_TOKEN) {
    ...
    rollbar.handleUncaughtExceptions(ROLLBAR_ACCESS_TOKEN, { exitOnUncaughtException: true });
  } else {
    console.log('ROLLBAR_ACCESS_TOKEN is not set; Rollbar will _not_ report uncaught exceptions!');
  }
